    ...
    return (
      <Layout currentPage={currentPage} onNavigate={onNavigate}>
        <div className="flex items-center justify-center h-64">
          <p className="text-neutral-600">Loading applicant details...</p>
        </div>
      </Layout>
    );
  }
                ...
                <ul className="space-y-2">
                  {applicant.ai_analysis.strengths.map((strength, index) => (
                    <li key={index} className="flex items-start">
                      ...
                      <span className="text-neutral-600 ml-2">{strength}</span>
                    </li>
                  ))}
                </ul>
              </div>
                ...
                <ul className="space-y-2">
                  {applicant.ai_analysis.concerns.map((concern, index) => (
                    <li key={index} className="flex items-start">
                      ...
                      <span className="text-neutral-600 ml-2">{concern}</span>
                    </li>
                  ))}
                </ul>
              </div>
